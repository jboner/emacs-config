...
;;; ----- sample -----
;(global-set-key [(meta f2)] 'func-name)     ; Meta+F2
;(global-set-key [(control f2)] 'func-name)  ; Ctrl+F2
;(global-set-key [(shift f2)] 'func-name)    ; Shift+F2
;(global-set-key [(meta up)] 'func-name)     ; Meta+↑
;(global-set-key [(control up)] 'func-name)  ; Ctrl+↑
;(global-set-key [(shift up)] 'func-name)    ; Shift+↑


;;; --- Pedal specific mappings ---
(define-key viper-vi-global-user-map [(meta left)]   'viper-visual-mode) 
