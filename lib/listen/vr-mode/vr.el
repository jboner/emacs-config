...
;;
;; $Id: vr.el,v 1.2 2004/09/14 02:06:47 klarlund Exp $
;;
...
;; This defadvice for subst-char-in-region doesn't work with Emacs
;; 21.3...., at least not 21.3.50.1 (infinite loop). It doesn't seem
;; necessary either. /Nils Klarlund /NK
...
;; ewww
(defun vr-etonl (i)
  ;; string instead of format; patch by Nils Klarlund
  (string
...
;; fixed read syntax (removed \)/Nils Klarlund
