...
;;   (message "major-mode=%s" major-mode)(sit-for 2)
;;   (easy-menu-add-item nxhtml-part-mode-map '("menu-bar" "nxhtml-part-mode" "File Transfer")
;;                       ["TESTINGEASY part part" 'nxhtml-part-view t])
;;     (define-key map [menu-bar nxhtml-mode nxhtml-upl-map test4]
;;       (list 'menu-item "TESTING 4" 'nxhtml-part-view))
;;     (define-key map [menu-bar nxhtml-part-mode nxhtml-upl-map test5]
;;       (list 'menu-item "TESTING 5" 'nxhtml-part-view))
...
Based on `nxml-mode."
  (progn
    ...
    (nxml-part-mode-enter)
;;   (define-key nxhtml-part-mode-map [menu-bar nxhtml-mode nxhtml-upl-map test2]
;;     (list 'menu-item "TESTING 2" 'nxhtml-part-view))
;;   (define-key nxhtml-mode-map [menu-bar nxhtml-mode nxhtml-upl-map test3]
;;     (list 'menu-item "TESTING 3" 'nxhtml-part-view))
;;   (run-with-idle-timer 0 nil 'nxhtml-part-testmap)
;;   (easy-menu-add-item nxhtml-part-mode-map '("menu-bar" "nxhtml-part-mode" "html-upl")
;;                       (list 'menu-item "TESTING EASY" 'nxhtml-part-view))
;;     (easy-menu-add-item nxhtml-mode-map '("menu-bar" "nxhtml-mode" "html-upl")
;;                         ["TESTINGEASY" 'nxhtml-part-view t])
;;     (easy-menu-add-item nxhtml-mode-map '("menu-bar" "nxhtml-mode" "File Transfer")
;;                         ["TESTINGEASY" 'nxhtml-part-view t])
;;     (easy-menu-add-item nxhtml-part-mode-map '("menu-bar" "nxhtml-mode" "File Transfer")
;;                         ["TESTINGEASY part" 'nxhtml-part-view t])
;;     (easy-menu-add-item nxhtml-part-mode-map '("menu-bar" "nxhtml-mode")
;;                         (easy-menu-create-menu "File Transfer" nil))
;;     (easy-menu-add-item nxhtml-part-mode-map '("menu-bar" "nxhtml-part-mode")
;;                         (easy-menu-create-menu "File Transfer part" nil))
    )
  )

;; (defun nxhtml-part-testmap()
;;   (define-key nxhtml-mode-map [menu-bar nxhtml-mode nxhtml-upl-map test3b]
;;     (list 'menu-item "TESTING 3b" 'nxhtml-part-view))
;;   (setq nxhtml-part-mode-map
;;         (let ((map (make-sparse-keymap)))
;;           (set-keymap-parent map nxhtml-mode-map)
;;           (define-key map [menu-bar nxhtml-mode nxhtml-upl-map test4]
;;             (list 'menu-item "TESTING 4" 'nxhtml-part-view))
...
;; (defvar nxhtml-part-done-function nil)
