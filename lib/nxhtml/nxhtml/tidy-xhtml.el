...
;; Lxast-Updated: Wed Apr 11 18:56:20 2007 (7200 +0200)
;; Version: 2.23
;; Keywords: languages
...
Any error messages generated by that program are sent to
\"*tidy-errors*\" buffer."
      ...
      (widget-create 'push-button
                     ...
                     :action (lambda (widget &optional event)
                               (let ((orig-buf (widget-get widget :arg-orig))
                                     (tidy-buf (widget-get widget :arg-tidy)))
                                 (tidy-check-is-tidied orig-buf tidy-buf)
                                 (tidy-ediff-buffers tidy-buf orig-buf))))
      ;;(widget-setup)
