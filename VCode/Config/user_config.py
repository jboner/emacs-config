...
#set_builder_preferences(['std_lower_intercaps', 'std_underscores'],
#                            language='',
#                            identifier='')
...
#Java_std_lib_sym = os.path.join(vc_globals.config, 'java_std_lib.sym')
#symbol_files.append(Java_std_lib_sym)
...
Java_abbrevs = os.path.join(vc_globals.config, 'java_abbrevs.py')
Scala_abbrevs = os.path.join(vc_globals.config, 'scala_abbrevs.py')

abbrev_files.append(std_abbrevs)
abbrev_files.append(py_abbrevs)
abbrev_files.append(C_Cpp_abbrevs)
abbrev_files.append(Java_abbrevs)
abbrev_files.append(Scala_abbrevs)
...
add_csc_set(java_statements)
add_csc_set(java_ctrl_structures)
add_csc_set(java_method_definitions)
add_csc_set(java_data_structures)
add_lsa_set(java_reserved_words)

# Scala-specific

add_csc_set(scala_statements)
add_csc_set(scala_ctrl_structures)
add_csc_set(scala_method_definitions)
add_csc_set(scala_test_definitions)
add_csc_set(scala_data_structures)
add_lsa_set(scala_reserved_words)

# Snippet template management
add_csc_set(snippet_template_management)
